...
<head>
<meta charset="utf-8">
<title>Syahadah Electronic</title>
<!-- Stylesheets -->
...
<link rel="shortcut icon" href="{{ asset('assets/images/logo-nf.png') }}" type="image/x-icon">
<link rel="icon" href="{{ asset('assets/images/logo-nf.png') }}" type="image/x-icon">
